...
The size of the sheath, in the collisionless case, is given by, 
...
In the case of the collisional regime solution, it is not possible to solve analytically the plasma discharge current. Instead, the maximum voltage across the sheath can be expressed in terms of the current and other plasma parameters~\cite{Lieberman1989}. If we use the sheath edge expression for the collisionless solution (\ref{eq:CollisionlessSheathEdge}) then the maximum voltage across the sheath results, 
\begin{equation}
...
In the collisional regime solution, the maximum voltage drop across the sheath when the sheath is fully extended at $t=0$ is, 
\begin{equation}
V(t=0) = V_0 = 2.5 H \frac{e n_s {s_0}^2}{\epsilon}
\end{equation}
And from this expression the discharge current density amplitude $J$ can be expressed as, 
\begin{equation}
J = 0.953845 \omega \left( \frac{ {n_s}^2 e^2 T_e {V_0}^2 {\epsilon_0}^3 }{\lambda_i}  \right)^{1/5}
\end{equation}
Alternatively, this expression can be used to determine the plasma density at the edge of the sheath ($n_s$) given the voltage drop across the sheath ($V_0$) and the current density ($J$). 

 
The $H$ parameter in the collisional regime is given by~\cite{Lieberman1989}
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  AC SHEATH BOTH solutions collisionless and collisional
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\subsubsection{Electric Field and Potential: common expression to both solutions in the AC Sheath}
